export const australiaQuestionnaire = {
  ...
  schemaVersion: 1,
  questions: [
    { type: "radio", field: "under45", label: { en: "Will you be under 45 when invited to apply?", zh: "收到申请邀请时，你是否会未满 45 岁？" } },
    { type: "radio", field: "occupation", label: { en: "Is your nominated occupation on the relevant skilled occupation list?", zh: "你的提名职业是否在目标签证适用的技术职业清单上？" } },
    { type: "radio", field: "assessment", label: { en: "Do you hold a suitable, valid skills assessment for that occupation?", zh: "你是否持有该提名职业的有效合格职业评估？" } },
    { type: "radio", field: "points", label: { en: "Is your estimated SkillSelect points score at least 65?", zh: "你的 SkillSelect 估算积分是否至少为 65 分？" } },
    { type: "radio", field: "english", label: { en: "Do you have at least Competent English?", zh: "你是否至少达到 Competent English？" } },
    { type: "radio", field: "stateNomination", label: { en: "Have you received state or territory government nomination?", zh: "你是否已获得州或领地政府提名？" } },
    { type: "radio", field: "relativeSponsor", label: { en: "Do you have an eligible relative sponsor usually resident in a designated regional area for subclass 491?", zh: "你是否有符合 491 条件、通常居住在指定偏远地区的合资格亲属担保？" } },
    { type: "radio", field: "regional", label: { en: "Are you and accompanying family willing to live, work and study in designated regional Australia?", zh: "你和同行家属是否愿意在指定偏远地区生活、工作和学习？" } },
  ],
  programs: {
